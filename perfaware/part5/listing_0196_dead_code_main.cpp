...
/* NOTE(casey): This is the asm volatile block recommended by the internet.
   It doesn't work very well. Can you figure out how to replace escape()
   with asm volatile blocks that work better? */
    escape(&Value);
